      ...
      <div className="container-editorial">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <a href="mailto:ainaracoachpnl@gmail.com" className="text-sm font-sans text-text-muted hover:text-primary transition-colors flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg> ainaracoachpnl@gmail.com
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/ainaracoach/" target="_blank" rel="noopener noreferrer" className="text-sm font-sans text-text-muted hover:text-primary transition-colors flex items-center gap-2">
