  ...
  return (
    <section className="py-16 px-4 bg-white">
      <div className="max-w-3xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.8 }} className="bg-surface rounded-3xl p-8 md:p-12 text-center space-y-6 shadow-sm border border-border">
          <div className="w-16 h-16 mx-auto rounded-full bg-white flex items-center justify-center shadow-md">
            <ShieldCheck className="w-8 h-8 text-mark" />
          </div>
          ...
          <div className="pt-6 border-t border-border">
            ...
            <p className="text-2xl font-bold text-text" style={{ fontFamily: "'Playfair Display', serif" }}>Ainara 💖</p>
